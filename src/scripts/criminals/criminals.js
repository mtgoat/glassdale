...
export const criminal = (taco) => {
    ...
    <section class="crimCard">
            ...
            <li ="criminals${taco.id}__startDate">Term started: ${new Date(taco.incarceration.start).toLocaleDateString('en-US')}
            </li>
            <li ="criminals${taco.id}__endDate">Term ended: ${new Date(taco.incarceration.end).toLocaleDateString('en-US')}</li>
        </ul>
        </section>
            `
}